...
- Online transcription uploads include `duration_seconds`; the Worker uses it for the daily recording-minute budget and falls back to one minute for stale PWA clients. This is app-reported metadata, not a tamper-proof media-duration measurement.
